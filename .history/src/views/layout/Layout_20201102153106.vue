    ...
    <el-container>
      ...
      <el-container class="h100">
        ...
        <el-container>
          ...
          <el-footer class="foter">本系统由专业会计有限公司&copy;进行维护及使用</el-footer>
        </el-container>
      </el-container>
    </el-container>
  </div>
...
export default {
  ...
  data() {
    return {
      lists: [
        { name: "首页", ico: "el-icon-s-platform", go: "", check: true },
  ...
  mounted() {
    this.i = localStorage.getItem('title')?localStorage.getItem('title'):"首页"
    //生命周期--已加载
  },
  computed: {
    username() {
