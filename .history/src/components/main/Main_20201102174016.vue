  ...
  <div>
    <div class="s">
      <el-cart>
        ...
        <el-row>
          <el-col :span="8"><ve-radar :data="chartData1"></ve-radar></el-col>
          <el-col :span="8"><ve-pie :data="chartData2"></ve-pie></el-col>
          <el-col :span="8"><ve-histogram :data="chartData3"></ve-histogram>
          </el-col>
        </el-row>
      </el-cart>
    </div>
