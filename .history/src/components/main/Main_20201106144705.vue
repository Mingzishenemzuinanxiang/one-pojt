        ...
        <el-row>
          <el-col>
            <el-card class="box-card">
              ...
              <charts type="line" :data="chartData"></charts>
            </el-card>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-card shadow="always">
             ...
             <charts type="radar" :data="chartData1"></charts>
            </el-card>
          </el-col>
          <el-col :span="8">
            <el-card shadow="always">
  ...
  methods: {
    getData(url) {
      this.$get(url).then((res) => {
        ...
        if (url === "radarChat") {
           this.chartData1.columns = Object.keys(res.data[0])
          this.chartData1.rows = res.data;
        }
        if (url === "ringChat") {
            this.chartData2.columns = Object.keys(res.data[0])
