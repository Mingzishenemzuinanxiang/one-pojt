<template>
  ...
  <div class="s">
   <el-row >
      <el-col :span="6"><div class="grid-content bg-purple"><ve-radar :data="chartData1"></ve-radar></div></el-col>
      <el-col :span="6"><div class="grid-content bg-purple"><ve-pie :data="chartData2"></ve-pie></div></el-col>
      <el-col :span="6"><div class="grid-content bg-purple"><ve-histogram :data="chartData3"></ve-histogram></div></el-col>
      <el-col :span="6"><div class="grid-content bg-purple">44444</div></el-col>
    </el-row>
  </div>
