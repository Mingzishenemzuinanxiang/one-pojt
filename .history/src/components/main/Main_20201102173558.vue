  ...
  <div>
    <div class="s">
      <el-row :gutter="24">
       ...
       <el-row :gutter="18">
      <el-col :span="6"><ve-radar :data="chartData1"></ve-radar></el-col>
      <el-col :span="6"><ve-pie :data="chartData2"></ve-pie></el-col>
      <el-col :span="6"><ve-histogram :data="chartData3"></ve-histogram></el-col>
    </el-row>
    </div>
  <div class="s">
